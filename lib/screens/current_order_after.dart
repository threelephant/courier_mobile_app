...
Future<CurrentOrderAfterInfo> fetchCurrentOrderAfterInfo(BuildContext context, int id) async {
  ...
  if (response.statusCode == 200) {
    ...
    return CurrentOrderAfterInfo.fromJson(responseJson);
...
class CurrentOrderAfterInfo {
  ...
  factory CurrentOrderAfterInfo.fromJson(Map<String, dynamic> json) {
    return CurrentOrderAfterInfo(
      id: json['id'],
      time: json['time'],
      status: json['status'],
      price: json['price'],
...
class CurrentOrderAfter extends StatelessWidget {
  final int id;

  CurrentOrderAfter({Key key, @required this.id}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<CurrentOrderAfterInfo>(
          future: fetchCurrentOrderAfterInfo(context, id),
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              CurrentOrderAfterInfo order = snapshot.data;
...
class CurrentOrderWidgetAfter extends StatelessWidget {
  ...
  _acceptOrder(context) async {
    ...
    var res = await http.post(Uri.parse("http://192.168.1.4:5000/api/courier/order/$id/deliver"),
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
